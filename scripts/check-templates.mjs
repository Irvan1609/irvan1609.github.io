...
const expected=['ral','rak','fral','frak','split','descriptive','correlation','path','regression','pca','combined','mixed','genetic','stability'];
...
console.log(`Templates verified: ${expected.length} analysis/rancangan templates, direct editor rows, decimal conversion, and multilocation cell coverage.`);

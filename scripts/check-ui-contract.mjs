...
if(!statStyle.includes('/* STAT MOBILE TAP TARGETS 2026-09-26 */')||!statStyle.includes('/* STAT MOBILE DOCK TAP TARGETS 2026-09-26 */')||!statStyle.includes('/* STAT MOBILE GROUP TAP TARGETS 2026-09-26 */')||!resultOsStyle.includes('/* RESULT OS MOBILE TAP TARGETS 2026-09-26 */'))fail('mobile tap-target safeguards missing');

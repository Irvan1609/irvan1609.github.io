...
const dirty=inspectDatasetForResearch({headers:['Plot ID','Perlakuan','Hasil'],rows:[['A1','P0','1,2'],['A1','P0','1.3'],['A3','P0','1.5'],['A4','P0','1.6'],['A5','P1','1.7'],['A6','P1','1.8'],['A7','P1','1.9'],['A8','P1','99']]});

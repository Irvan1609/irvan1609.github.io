...
console.log('Field Zero check OK: rupiah economy, Sulsel realism, mobile comfort, RAL/RAK learning, 24-plot blind-selection Breeding Cup and local /stat simulation transfer are wired.');

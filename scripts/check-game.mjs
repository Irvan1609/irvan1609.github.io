...
for(const marker of ['speciesProfile','recommendedParameters','rice','soybean','Jumlah anakan','Polong isi','makeSubsamples','sampleMeasurements','aggregateSamples','plotCarryover','evidenceLabel','founderGenome','crossGenome','selfGenome','geneticEffects','analyzeExperiment','auditDesign','makeProgeny','genomeStats','heritability','repeated-measure','LINKAGE_GROUPS','linkedGamete','recombination','inbreeding','heterosis'])if(!academy.includes(marker))fail('academy model missing '+marker);
...
console.log('Field Zero check OK: professor academy v2 plus staged breeding, direct field selection, phenotype cues, linkage/recombination, inline ANOVA, research reputation, thematic contracts, rival progression and deterministic Daily Breeding are wired.');

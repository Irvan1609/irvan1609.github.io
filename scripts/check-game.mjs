...
for(const marker of ['G + E + M','G×E','G×M','24*135000','TENDERS','STRATEGIES','DIAGNOSTICS','DATA SIMULASI','Uji akhir rahasia','Pilih tepat 2 galur','finalTest'])if(!competition.includes(marker))fail('Breeding Cup missing '+marker);

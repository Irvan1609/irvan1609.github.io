...
function installDataGrid(){
  $('#pasteBtn').onclick=openModal;$('#pasteCancel').onclick=closeModal;$('#pasteApply').onclick=applyPasted;$('#pasteArea').oninput=previewPaste;$('#csvInput').onchange=importCSV;$('#newTxt').onclick=newTXT;$('#addRow').onclick=addRow;$('#addColumn').onclick=addColumn;$('#clearData').onclick=clearData;$('#renameDataset').onclick=renameDataset;$('#datasetNameForm').onsubmit=saveDatasetName;$('#deleteDataset').onclick=deleteDataset;$('#downloadDataset').onclick=downloadDataset;

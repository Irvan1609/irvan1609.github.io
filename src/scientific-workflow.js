...
async function analyze(){
  ...
  try{
    ...
    document.dispatchEvent(new CustomEvent('agrotik-analysis-complete',{detail:{
      dataset:data.name,
      fileName:activeSource?.fileName||data.name,
      design:currentDesign,
      designLabel:designNames[currentDesign]||currentDesign,
...
function openScientificRecipe(recipe){
  ...
  requestAnimationFrame(()=>{
    ...
    validate();
    $('#scienceRunStatus').textContent='Recipe dipulihkan · periksa lalu jalankan';
  });
}

export function installNavigation(){
  ...
  function closeMenus(){for(const id of ['fileMenu','helpMenu']){document.getElementById(id).hidden=true;document.getElementById(id+'Button').setAttribute('aria-expanded','false');}}
  ...
  document.getElementById('openAnalysis').addEventListener('click',closeMenus);
